package matheus.bcc.mymusicapp.db.dal;
...
import matheus.bcc.mymusicapp.db.util.Conexao;
...
{   private Conexao con;
    ...
    public Genero get(int id) {   Genero o = null;
    ...
    public ArrayList <Genero> get(String filtro) {   ArrayList <Genero> objs = new ArrayList<>();
